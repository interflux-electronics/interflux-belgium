...
export function markdown(str: string, options: Options = {}): string {
  if (!str) {
    return str;
  }
...
const convertBlockquote = (str: string) => {
...
const convertInlineElements = (str: string) => {
